		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapcomlistbindingfromodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomlistbindingfromodata-display": {
								"semanticObject": "sapcomlistbindingfromodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.listbindingfromodata",
									"url": sap.ui.require.toUrl("sap/com/listbindingfromodata")
								}
							}
						}
					}

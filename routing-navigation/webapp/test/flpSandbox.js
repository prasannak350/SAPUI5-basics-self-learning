		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapcomroutingnavigation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomroutingnavigation-display": {
								"semanticObject": "sapcomroutingnavigation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.routingnavigation",
									"url": sap.ui.require.toUrl("sap/com/routingnavigation")
								}
							}
						}
					}

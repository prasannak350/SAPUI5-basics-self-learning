		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapcomfilteringsorting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomfilteringsorting-display": {
								"semanticObject": "sapcomfilteringsorting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.filteringsorting",
									"url": sap.ui.require.toUrl("sap/com/filteringsorting")
								}
							}
						}
					}

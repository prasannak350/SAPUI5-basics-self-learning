		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fragment",
									"targetURL": "#sapcomfragment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomfragment-display": {
								"semanticObject": "sapcomfragment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.fragment",
									"url": sap.ui.require.toUrl("sap/com/fragment")
								}
							}
						}
					}

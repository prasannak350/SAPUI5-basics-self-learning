		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapcomdynamicparametersinresourcemodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomdynamicparametersinresourcemodel-display": {
								"semanticObject": "sapcomdynamicparametersinresourcemodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.dynamicparametersinresourcemodel",
									"url": sap.ui.require.toUrl("sap/com/dynamicparametersinresourcemodel")
								}
							}
						}
					}

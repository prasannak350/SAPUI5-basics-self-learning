		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapcrudoperationsodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapcrudoperationsodata-display": {
								"semanticObject": "comsapcrudoperationsodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.crudoperationsodata",
									"url": sap.ui.require.toUrl("com/sap/crudoperationsodata")
								}
							}
						}
					}

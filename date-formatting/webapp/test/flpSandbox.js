		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapcomdateformatting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomdateformatting-display": {
								"semanticObject": "sapcomdateformatting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.dateformatting",
									"url": sap.ui.require.toUrl("sap/com/dateformatting")
								}
							}
						}
					}

		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapcomzproductproj-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomzproductproj-display": {
								"semanticObject": "sapcomzproductproj",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.zproductproj",
									"url": sap.ui.require.toUrl("sap/com/zproductproj")
								}
							}
						}
					}

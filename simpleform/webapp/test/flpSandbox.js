		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapcomsimpleform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomsimpleform-display": {
								"semanticObject": "sapcomsimpleform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.simpleform",
									"url": sap.ui.require.toUrl("sap/com/simpleform")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapcomtablebindingodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomtablebindingodata-display": {
								"semanticObject": "sapcomtablebindingodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.tablebindingodata",
									"url": sap.ui.require.toUrl("sap/com/tablebindingodata")
								}
							}
						}
					}

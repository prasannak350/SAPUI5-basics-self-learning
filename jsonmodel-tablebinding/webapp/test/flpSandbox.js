		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapcomjsonmodeltablebinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomjsonmodeltablebinding-display": {
								"semanticObject": "sapcomjsonmodeltablebinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.jsonmodeltablebinding",
									"url": sap.ui.require.toUrl("sap/com/jsonmodeltablebinding")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapcompassingdatafromtabletofragment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcompassingdatafromtabletofragment-display": {
								"semanticObject": "sapcompassingdatafromtabletofragment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.passingdatafromtabletofragment",
									"url": sap.ui.require.toUrl("sap/com/passingdatafromtabletofragment")
								}
							}
						}
					}

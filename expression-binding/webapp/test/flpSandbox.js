		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapcomexpressionbinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomexpressionbinding-display": {
								"semanticObject": "sapcomexpressionbinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.expressionbinding",
									"url": sap.ui.require.toUrl("sap/com/expressionbinding")
								}
							}
						}
					}
